window.addEventListener('load', () => {
    ...
    const maxLevel = 4; // depth of the fractal, or amount of times branches will split
    const branches = 2;

    let sides = 5; // number of branches
    let scale = 0.5; // how smaller than there parent branch
    let spread = 0.5; // angle of there parent branches and their segments 0.1 - 2.9 seems to be the sweet spot
